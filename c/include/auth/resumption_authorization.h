...
typedef enum {
    ...
    RESUMPTION_REASON_CREDENTIAL_MISSING = 3,
    RESUMPTION_REASON_CREDENTIAL_INVALID = 4,
    RESUMPTION_REASON_BINDING_MISMATCH = 5,
    RESUMPTION_REASON_EXPIRED = 6,
    RESUMPTION_REASON_REUSE_LIMIT_REACHED = 7,
    RESUMPTION_REASON_AUTHORIZATION_CONTEXT_MISSING = 8,
    RESUMPTION_REASON_AUTHORIZATION_STALE = 9,
