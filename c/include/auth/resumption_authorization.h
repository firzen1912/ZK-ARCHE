...
typedef enum {
    ...
    RESUMPTION_REASON_AUTHORIZATION_GENERATION_STALE = 11,
    RESUMPTION_REASON_REVOCATION_STALE = 12,
    RESUMPTION_REASON_REVOKED = 13,
    RESUMPTION_REASON_LINEAGE_STALE = 14,
    RESUMPTION_REASON_RESTART_CONTINUITY_STALE = 15,
    RESUMPTION_REASON_CREDENTIAL_EPOCH_STALE = 16,
    RESUMPTION_REASON_SESSION_INVALIDATED = 17,
    RESUMPTION_REASON_PEER_MISMATCH = 18,
    RESUMPTION_REASON_DEPLOYMENT_MISMATCH = 19,
    RESUMPTION_REASON_AUDIENCE_MISMATCH = 20,
    RESUMPTION_REASON_PROFILE_MISMATCH = 21
} resumption_reason_t;
