...
typedef enum {
    ...
    TRANSPORT_CONTINUATION_REASON_AUTHORIZATION_GENERATION_UNBOUND = 7,
    TRANSPORT_CONTINUATION_REASON_AUTHORIZATION_GENERATION_STALE = 8,
    TRANSPORT_CONTINUATION_REASON_PEER_CONTEXT_MISMATCH = 9,
    TRANSPORT_CONTINUATION_REASON_PROFILE_CONTEXT_MISMATCH = 10,
    TRANSPORT_CONTINUATION_REASON_BINDING_INVALID = 11,
    TRANSPORT_CONTINUATION_REASON_RESUMPTION_NOT_AUTHORIZED = 12,
    TRANSPORT_CONTINUATION_REASON_CONTINUATION_NOT_REQUESTED = 13
