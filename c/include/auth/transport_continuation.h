...
typedef enum {
    ...
    TRANSPORT_CONTINUATION_REASON_PEER_CONTEXT_MISMATCH = 6,
    TRANSPORT_CONTINUATION_REASON_PROFILE_CONTEXT_MISMATCH = 7,
    TRANSPORT_CONTINUATION_REASON_BINDING_INVALID = 8,
    TRANSPORT_CONTINUATION_REASON_RESUMPTION_NOT_AUTHORIZED = 9,
    TRANSPORT_CONTINUATION_REASON_CONTINUATION_NOT_REQUESTED = 10
