    ...
    fn canonical_v3_corpus_matches_classifier() {
        ...
        for line in corpus.lines() {
            ...
            let facts = P2pDelegationFacts {
                ...
                epoch_current: bit(fields[12]),
                revocation_current: bit(fields[13]),
                explicitly_revoked: bit(fields[14]),
                lineage_current: bit(fields[15]),
                depth_within_limit: bit(fields[16]),
                redelegation_permitted: bit(fields[17]),
                redelegation_requested: bit(fields[18]),
