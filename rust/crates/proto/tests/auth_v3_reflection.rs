...
fn auth_v3_finished_rejects_cross_direction_reflection() {
    let session_key = bytes32("5cea979c840f9cb1302db41f7dcfe91c4f8b22f7019b0586db183219e27ef348");
    ...
    let server_key_with_client_label = finished_tag_v3(&k_s2c, b"client finished v3", &th);
    let client_key_with_server_label = finished_tag_v3(&k_c2s, b"server finished v3", &th);
