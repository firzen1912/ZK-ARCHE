...
| R-007 | CFRG-informed conformance/security review of the CDS OR-composed role-membership proof | reproduce | mathematical proof contract; simulator/completeness/soundness/ZK assumption matrix; canonical unique role-list semantics including ordering, duplicate rejection, empty/max-cardinality behavior; Fiat–Shamir session/instance separation covering protocol version/method/suite/profile or a compositional proof of equivalent higher-layer binding; witness-independent real/simulated clause control flow, memory access and randomness schedule or an explicitly scoped/measured side-channel claim; nonzero-scalar sampling review; Rust/C canonical point/scalar parse parity; malformed/identity/noncanonical differential and negative vectors; independent cryptographic and side-channel review | TD-001 / assurance / future proof ADR/spec text | 2026-09-18 |
