...
| R-013 | Credential-learning/trust-store mutation policy and credential-reference-to-key/role/policy binding | reproduce | `NO-LEARNING` baseline for normal AUTH/P2P; explicit authorized-learning exceptions for ENROLL/commissioner; credential/reference binding to public key or commitment, role/policy context, deployment/domain, epoch, and authorization provenance; mismatch/misconfigured-store negative tests; auditable trust-store mutations; stateful Tamarin/ProVerif model with attacker/misconfiguration influence over mappings | zk207/zk211/zk212/zk214/zk217/zk220/zk226/zk239 / future TRUST/ENROLL spec and assurance | 2026-08-21 |
